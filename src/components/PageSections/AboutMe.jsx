...
function AboutMe() {
    return <div className="aboutme">
        <img className="aboutme__image" src={joelicon} alt="A picture of Joel" />
        <div className="aboutme__textdiv">
            <p className="aboutme__text">
                ...
                development to collaborate and create top-quality projects. Interested? I'd love to join your team.
          </p>
        </div>
    </div>;
}
